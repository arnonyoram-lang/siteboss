...
name: Hi-Tech
version: 0.3.0
description: Rothschild high-rise minimalism, Hebrew-first. White surface, deep navy ink, Monday-signature purple accent. Sharp, ambitious, technical.
colors:
  primary: "#0A1A2F"
  surface: "#FFFFFF"
  tertiary: "#6161FF"
...
- **Accent (#6161FF)**: electric blue, the only attention-getter. Used for primary CTAs, links, focus rings.
